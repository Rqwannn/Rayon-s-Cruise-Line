    ...
    <form method="POST">
            <div class="edit-card">
                <div class="card">
                    ...
                    <button type="submit" id="submit" onclick="return validasi(event)">Cari Tiket</button>
                </div>
            </div>
        </form>
            <div class="tujuan">
        ...
        <section class="section-info-tiket" style="display: none;">
                    ...
                    <?php if($result["tiket"] != 0 && strtotime(date("Y-m-d")) < strtotime($result['tanggal'])) : ?>
                        <div class="card-info">
                            ...
                            <div class="card-info-harga">
                                ...
                                <a href="<?php echo BASEURL;?>/tiket/<?php echo $result["id"] ?>"
                                style="color: #fff; text-decoration: none;"><button type="submit" name="submit" id="submit">Beli Tiket</button></a>
                            </div>
            ...
            <div class="logo-center">
                <div class="logo">
                    ...
                    <div class="detail-2">
                        ...
                        <a href="#" style="color: #1877f2;"><h5>Batalkan Pelayaran Anda</h5></a>
                    </div>
                </div>
                <div class="logo">
                    ...
                    <div class="detail-2">
                        ...
                        <a href="#" style="color: #1877f2;"><h5>Tebus Kredit Pelayaran Anda</h5></a>
                    </div>
                </div>
                <div class="logo">
                    ...
                    <div class="detail-2">
                        ...
                        <a href="#" style="color: #1877f2;"><h5>Temukan pelayaran Anda berikutnya</h5></a>
                    </div>
                </div>
        ...
        <section class="section-center">
            <div class="left-side-card">
                ...
                <a href="<?php echo BASEURL; ?>/kapal"><h4>View Our Ship</h4></a>
                ...
                <div class="under-left">
                    ...
                    <div class="card-under-left">
                        ...
                        <a href="#"><h4 style="margin-left: 60px; margin-top: 80px;">Telusuri Kemana Kami berlayar</h4></a>
                    </div>
                </div>
            </div>
            <div class="card-right-slide">
                ...
                <div class="detail-pesiar">
                    <a href="#"><i class="fas fa-ship" style="transform: translate(32px, 35px); font-size: 18px;"></i><h5>The Best Ship You Can Ride</h5></a>
        ...
        <section class="section-3">
            ...
            <div class="holiday">
                ...
                <div class="cards-holiday">
                    ...
                    <a href="#"><h4 style="margin-left: 40px;">Explore</h4></a>
                </div>
                <div class="cards-holiday" style="position: absolute; width: 380px; right: 1px; top: 700px;">
                    ...
                    <a href="#"><h4 style="margin-left: 40px;">Learn More</h4></a>
                </div>
            </div>
    ...
    <section class="section-4">
        ...
        <div class="content-last">
            ...
            <div class="last-card">
                ...
                <a href="#"><h5>Explore Menu Makan</h5></a>
                </div>
            </div>
            <div class="row-row">
                <div class="row-card">
