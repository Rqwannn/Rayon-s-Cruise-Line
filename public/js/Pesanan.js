        ...
        $(document).ready(function(){
            ...
            success : function(result){
                ...
                let id = result.id;
                let data = result.confirmed == "0" ? "Note: Harap Selesaikan Pembayaran !"
                ...
                <div class="kapal-konfirmasi-flex">
                    <a href="http://localhost/MVC-KapalLaut/public/pembayaran/`+id+`">
                        <label class="close-pesanan close-pesanan-edit">Konfirmasi</label>
                    </a>
                    <a href="http://localhost/MVC-KapalLaut/public/pesanan/hapus/`+id+`">
